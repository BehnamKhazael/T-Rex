...
public class Marshaller {
	...
	public static byte[] getByteArray(UnPubPkt pkt) {
	...
	protected static int getNumBytes(UnPubPkt pkt) {
		int size = 0;
		size += getNumBytes(pkt.getEventType());
		size += getNumBytes(pkt.getAttributes());
		return size;
	...
	protected static int encode(UnPubPkt source, byte[] dest, int startIndex) {
	...
	protected static int getSize(UnPubPkt unPubPkt){
