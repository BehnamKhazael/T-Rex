...
WHERE 	   : 'Where';
CONSUMING  : 'Consuming';
VALTYPE    : 'String' | 'Int' | 'Float' | 'Bool' | 'Quality' ;
...
predicate : EVT_NAME '(' ((param_mapping | attr_constraint | attr_parameter | param_atom) (LOGICAL_OPERATOR (param_mapping | attr_constraint | attr_parameter | param_atom))*)? ')' event_alias? ;
