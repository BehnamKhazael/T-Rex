...
package trex.communication;

import java.io.IOException;
import java.io.OutputStream;
import java.net.Socket;

import trex.common.SubscriptionsTable;
...
public class TransportManager {
	...
	/**
	 * There is a separate method other than {@link #send(TRexPkt)}
	 * just for {@link RulePkt} as {@link RulePkt}s are not
	 * TRexClient {@link TRexPkt}s. This is only for testing.
	 */
	/*
