...
public class RulePktValueReference extends OpValueReference {
	...
	//Behnam TODO I add this new method, but please check the Marshalling it may affect
	public boolean isNegIndex() {
		return (stype==StateType.NEG);
	}
	...
	public OpValueReference dup() {
		if (name != null)
			return new RulePktValueReference(index, stype, name);
		else
